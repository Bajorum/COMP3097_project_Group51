...
class FoodListViewController: UIViewController {
    ...
    private func setupTableView() {
        ...
        tableView.estimatedRowHeight = 120 // Increased for quantity controls
    }
}
...
extension FoodListViewController: FoodItemCellDelegate {
    ...
    func didToggleFavorite(for foodItem: FoodItem) {
        ...
        // Refresh the table to update all cells with this food item
    ...
    private func showCreateGroupDialog(for foodItem: FoodItem, quantity: Int) {
        ...
        let createAction = UIAlertAction(title: "Create", style: .default) { [weak self, weak alertController] _ in
            ...
            self.dataManager.addToGroup(foodItem, groupName: groupName, quantity: quantity)
        }
